...
// Hard-code the token and Sid here or use process.env.TWILIO_AUTH_TOKEN, if it is saved in environment variable.
const accountSid = '';
const authToken = '';
...
app.post('/', (req, res) => {
  ...
  twilio.calls.create({
    url: 'https://twiml-phonebuzz-p2.herokuapp.com/voice',
...
app.post('/handle', (req, res) => {
  ...
  if (client.validateExpressRequest(req, authToken, { url: 'https://twiml-phonebuzz-p2.herokuapp.com/handle'})) {
    const twiml = new VoiceResponse();
